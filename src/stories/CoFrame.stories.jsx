...
CoFrame.args = {
  ...
  items: {
    ...
    "machine-ac5a063a-9ff9-4c0a-8fa6-81d3983f4a10-collision": {
      shape:
        "package://evd_ros_tasks/tasks/3d_printer_machine_tending/collision_meshes/MK2-Printer.stl",
    ...
    table: {
      shape:
        "package://evd_ros_tasks/tasks/3d_printer_machine_tending/models/Table/Table.stl",
      name: "Table",
      frame: "table",
      position: {
        x: 0,
    ...
    pedestal: {
      shape:
        "package://evd_ros_tasks/tasks/3d_printer_machine_tending/models/ur3e-Pedestal/Pedestal.stl",
      name: "Pedestal",
      frame: "pedestal",
      position: {
        x: 0,
  ...
  hulls: {
    usage: {
      ...
      color: {
        ...
        g: 200,
        b: 235,
        a: (time) => Math.sin(time / 1000) / 6 + 0.25,
      },
      wireframe: false,
      highlighted: true,
      showName: false,
