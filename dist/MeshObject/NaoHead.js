...
var _NaoHead = _interopRequireDefault(require("./meshes/NaoHead.glb"));
...
function Model(props) {
  ...
  console.log(_NaoHead.default);

  var _useGLTF = (0, _drei.useGLTF)(_NaoHead.default),
...
_drei.useGLTF.preload(_NaoHead.default);